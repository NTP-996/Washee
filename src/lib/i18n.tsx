...
const DICT = {
  en: {
    ...
    'booking.chooseCarType': 'Choose your car type',
    'booking.choosePackage': 'Choose a wash package',
    'booking.noPackages': 'No packages available for this car type yet.',
    'booking.changePackage': 'Change',
    'booking.carLocation': 'Car location',
    'booking.phone': 'Contact phone',
    'booking.phone.hint': "The driver will call this number if they can't find you.",
    'booking.total': 'Total',
    ...
    'history.declineReason': 'Driver declined',
    ...
    'booking.waitingTitle': 'Waiting for driver confirmation',
    'booking.waitingHint': "We'll let you know the moment your driver confirms.",
    'booking.confirmedTitle': 'Driver confirmed',
    'booking.confirmedHint': 'Your driver is on the way.',
    'booking.inProgressTitle': 'Wash in progress',
    'booking.awaitingPaymentTitle': 'Wash done',
    'booking.awaitingPaymentHint': 'Please pay your driver in cash.',
    'booking.declinedTitle': 'Booking declined',
    'review.rate': 'Rate this wash',
    'review.wash': 'Wash quality',
    'review.driver': 'Driver',
    'review.comment': 'Comment (optional)',
    'review.commentPlaceholder': 'How was the service?',
    'review.submit': 'Submit review',
    'review.submitted': 'Thanks for your feedback!',
    'review.errSubmit': 'Could not submit your review',
  ...
  vi: {
    ...
    'booking.change': 'Đổi',
    'booking.chooseCarType': 'Chọn loại xe của bạn',
    'booking.choosePackage': 'Chọn gói rửa xe',
    'booking.noPackages': 'Chưa có gói nào cho loại xe này.',
    'booking.changePackage': 'Đổi',
    'booking.carLocation': 'Vị trí xe',
    'booking.phone': 'Số điện thoại liên hệ',
    'booking.phone.hint': 'Tài xế sẽ gọi số này nếu không tìm thấy bạn.',
    ...
    'history.declineReason': 'Tài xế đã từ chối',
    'status.pending': 'Chờ xác nhận',
    'status.confirmed': 'Đã xác nhận',
    'status.in_progress': 'Đang rửa xe',
    'status.awaiting_payment': 'Chờ thanh toán',
    'status.declined': 'Đã từ chối',
    'status.cancelled': 'Đã hủy',
    'status.completed': 'Hoàn tất',
    'booking.waitingTitle': 'Đang chờ tài xế xác nhận',
    'booking.waitingHint': 'Chúng tôi sẽ báo ngay khi tài xế xác nhận.',
    'booking.confirmedTitle': 'Tài xế đã xác nhận',
    'booking.confirmedHint': 'Tài xế đang trên đường đến.',
    'booking.inProgressTitle': 'Đang rửa xe',
    'booking.awaitingPaymentTitle': 'Rửa xe xong',
    'booking.awaitingPaymentHint': 'Vui lòng thanh toán tiền mặt cho tài xế.',
    'booking.declinedTitle': 'Lịch đã bị từ chối',
    'review.rate': 'Đánh giá lần rửa xe này',
    'review.wash': 'Chất lượng rửa xe',
    'review.driver': 'Tài xế',
    'review.comment': 'Nhận xét (tùy chọn)',
    'review.commentPlaceholder': 'Dịch vụ thế nào?',
    'review.submit': 'Gửi đánh giá',
    'review.submitted': 'Cảm ơn bạn đã phản hồi!',
    'review.errSubmit': 'Không thể gửi đánh giá',
