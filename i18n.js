/* ==========================================================================
   washee — landing page bilingual layer (English / Vietnamese)
   Plain script (loads before main.js). Translatable nodes are marked in the
   HTML with data-i18n (textContent), data-i18n-html (innerHTML, for strings
   that carry brand markup), data-i18n-ph (placeholder) and data-i18n-aria
   (aria-label). The choice is remembered in localStorage and auto-detected
...
(() => {
  ...
  const I18N = {
    en: {
      docTitle: 'washee — Your car, washed where it stands',
      ...
      hero_title2: '<em class="grad-text">washed</em> where it stands',
      hero_sub: 'Book in 30 seconds. A vetted pro comes to you — driveway, office lot, or curbside. Track every minute, pay cashless, drive off shining.',
      ...
      hero_ticker: 'Live now: <strong>312 washers</strong> active near you',
      hero_scroll: 'Scroll',
      ...
      how_lead: 'No bucket, no hose, no standing around. washee routes a pro to wherever your car is parked.',
      ...
      track_lead: 'From booked to brilliant — every step lives on your map. No guessing, no waiting windows, no phone tag.',
      ...
      track_panel_aria: 'App preview: a washer en route to your car with live ETA and status updates',

      /* wash tiers */
      tiers_eyebrow: 'Wash tiers',
      tiers_title: 'Pick your shine',
      tiers_lead: 'Two ways to glow. Both are a swirl-free premium hand wash with our eco-friendly “proper wash” method — done wherever your car stands.',
      ...
      quote1: '"Booked from my desk, came down at lunch and the car looked showroom-new. Didn\'t lift a finger."',
      quote1_loc: 'San Diego',
      quote2: '"The live tracking is the best part — I watched Minh roll up, exactly when the app said. No waiting around."',
      quote2_loc: 'Austin',
      ...
      washers_lead: 'Wash on your schedule, earn on your terms. Jobs route straight to you, payouts hit instantly.',
    ...
    vi: {
      docTitle: 'washee — Xe của bạn, rửa sạch ngay tại chỗ',
      ...
      hero_title2: '<em class="grad-text">rửa sạch</em> ngay tại chỗ',
      hero_sub: 'Đặt lịch trong 30 giây. Thợ rửa được kiểm định đến tận nơi — sân nhà, bãi đỗ công ty hay lề đường. Theo dõi từng phút, thanh toán không tiền mặt, lái đi bóng loáng.',
      ...
      hero_ticker: 'Đang hoạt động: <strong>312 thợ rửa</strong> gần bạn',
      ...
      track_lead: 'Từ lúc đặt đến khi xe sáng bóng — mọi bước đều hiện trên bản đồ. Không phải đoán, không phải chờ, không gọi qua gọi lại.',
      ...
      track_panel_aria: 'Xem trước ứng dụng: thợ đang trên đường đến xe bạn cùng thời gian đến và cập nhật trạng thái trực tiếp',

      /* wash tiers */
      tiers_eyebrow: 'Gói rửa xe',
      tiers_title: 'Chọn độ bóng của bạn',
      tiers_lead: 'Hai cách để xe bóng loáng. Cả hai đều là dịch vụ rửa tay cao cấp không xước, theo phương pháp “rửa chuẩn” thân thiện môi trường — ngay tại nơi bạn đỗ xe.',
      ...
      quote1: '“Đặt ngay tại bàn làm việc, ra xem giờ trưa là xe như mới xuất xưởng. Không phải động tay.”',
      quote1_loc: 'San Diego',
      quote2: '“Theo dõi trực tiếp là hay nhất — tôi thấy Minh đến đúng như ứng dụng báo. Không phải chờ đợi.”',
      quote2_loc: 'Austin',
      ...
      washers_lead: 'Rửa theo lịch của bạn, thu nhập theo cách của bạn. Việc đến thẳng tay bạn, nhận tiền tức thì.',
  ...
  const initial = saved || ((navigator.language || '').toLowerCase().startsWith('vi') ? 'vi' : 'en');

  const dict = (lang) => I18N[lang] || I18N.en;
  const t = (lang, key) => dict(lang)[key] ?? I18N.en[key] ?? key;
  ...
  function applyLang(lang) {
    ...
    document.querySelectorAll('[data-i18n-html]').forEach((node) => {
      node.innerHTML = t(lang, node.dataset.i18nHtml);
    });
    document.querySelectorAll('[data-i18n-ph]').forEach((node) => {
      node.placeholder = t(lang, node.dataset.i18nPh);
    });
